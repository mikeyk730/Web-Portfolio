...
<div class="text-section">
    ...
    <p>The day starts off with a surprise.  The forest is filled with frantic, high-pitched calls of alarmed chimpanzees.  Our guide slows to a crawl and holds his rifle close.  Before us, partially hidden in the trees, stands a giant – a forest elephant.  Unlike their Savannah relatives, forest elephants are solitary, aggressive, and very suspicious to any change (a person, for example) in their environment.  As much as his majesty deserves to be observed and appreciated, we cautiously creep back and make an escape.  The chimp cries carry on.</p>
